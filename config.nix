  ...
  admins = [
    {
      ...
      keys = {
        ssh = [
          ...
          "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKiXYfgWXvTSAVnBPBObPB31KtVQ2XfyRpGSHJr8GsO9 root@hamilton"
          "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILVLuvIz8TSxajOM1PyUGI3G6nylrsZo23EpdD4nSJ38 root@macadamia"
        ];
        age = [
